...
export function ConsentBanner() {
  ...
  return (
    ...
    >
      <div className="mx-auto flex max-w-[1400px] flex-col gap-4 px-4 py-5 sm:px-8 md:flex-row md:items-center md:justify-between">
        ...
        <div className="flex shrink-0 flex-wrap items-center gap-3">
          <button
            ...
            className="font-mono text-[11px] uppercase tracking-label opacity-70 transition hover:opacity-100"
          >
            Essential only
          </button>
          <button
            onClick={() => decide(true)}
            className="rounded-[var(--radius)] bg-[hsl(var(--accent))] px-5 py-2.5 font-mono text-[11px] uppercase tracking-label text-[hsl(var(--accent-foreground))] transition hover:brightness-110"
          >
            Accept analytics
          </button>
        </div>
