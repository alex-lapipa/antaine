...
export const POSTS: Post[] = [
  {
    ...
    blocks: [
      ...
      { t: "p", text: "My taste has always leaned towards the deeper side of electronic music: the hypnotic repetition of Detroit techno, the spaciousness of dub techno, the evolving textures of Berlin — artists who treat synthesizers as instruments to be explored rather than machines for producing chart hits. Much of that philosophy is in the music I make." },
